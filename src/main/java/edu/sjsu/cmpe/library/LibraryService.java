...
public class LibraryService extends Service<LibraryServiceConfiguration> {
	    ...
	    Environment environment) throws Exception 
	{
		...
		//ReviewRepositoryInterface reviewRepository = new ReviewRepository(new ConcurrentHashMap<Long, Review>());
		//environment.addResource(new ReviewResource(reviewRepository));
		ReviewRepositoryInterface reviewRepository = new ReviewRepository(new HashMap<Long, Review>());
		environment.addResource(new ReviewResource(reviewRepository));
    }
}
